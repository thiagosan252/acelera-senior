...
import br.atos.impacta.controller.DeletarGerenteControlador;
import br.atos.impacta.repository.RepositorioGerente;

public class DeletarGerente implements Telas {
	...
	public DeletarGerente(JFrame jFrameMenuInicial, RepositorioGerente repositorioGerente) {
	...
	public JPanel createPanel(JFrame jFrame) {
		...
		DeletarGerenteControlador deletarGerenteControlador = new DeletarGerenteControlador(jFrame,
				this.jFrameMenuInicial, this.repositorioGerente, jTextField);

		jButton.addActionListener(deletarGerenteControlador);
